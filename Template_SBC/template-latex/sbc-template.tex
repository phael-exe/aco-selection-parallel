...
pequeno. Em bases de poucos milhares de instâncias, a CPU multicore é a melhor escolha. O tempo
sequencial (Tabela~\ref{tab:baseline}) evidencia o custo $O(N^2 F)$ da avaliação: a base
\textit{vaccine} é a mais lenta mesmo tendo menos instâncias que \textit{Employee} e
\textit{brain-stroke}, por possuir 40 atributos --- contra 8 a 19 das demais.
...
\hline
\textbf{Dataset} & \textbf{N} & \textbf{F} & \textbf{Seq.\ (ms)} & \textbf{CUDA} & \textbf{OpenMP (melhor)} \\
\hline
heart\_failure & 299  & 12 & 82,1    & 0,7$\times$ & 2,9$\times$ \\
haberman       & 306  & 3  & 72,2    & 1,8$\times$ & 3,6$\times$ \\
cirrhosis      & 418  & 19 & 161,4   & 0,9$\times$ & 4,0$\times$ \\
diabetes       & 768  & 8  & 275,8   & 1,5$\times$ & 4,5$\times$ \\
tic-tac-toe    & 958  & 9  & 670,6   & 1,8$\times$ & 5,8$\times$ \\
yeast          & 1484 & 8  & 861,2   & 2,4$\times$ & 6,5$\times$ \\
vaccine        & 3152 & 40 & 16439,7 & 5,9$\times$ & 13,0$\times$ \\
Employee       & 4653 & 8  & 5442,5  & 7,4$\times$ & 10,4$\times$ \\
brain-stroke   & 4981 & 10 & 7773,9  & 8,2$\times$ & 11,5$\times$ \\
\hline
\end{tabular}
\end{table}
